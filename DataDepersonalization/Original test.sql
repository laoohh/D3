...
where PersonTypeId=2301 
      and (CAI = 'hun_amazon' or CAI = 'usa_amazon' or CAI = 'CMSDataMigration');



select PersonID, CAI, PersonTypeID, Building 
from NPerson
where Building in ('UZB2','HRV3','HUN2','BRU1','ABE2','ABE3')
...
where country in ('Uzbekistan','Belgium','Croatia','Hungary')

select * 
from IR_MAP_IR_MAP_sample_facman_data#csv
where name in ('UZB2','HRV3','HUN2','BRU1','ABE2','ABE3')
...
select * from EIR_IR_Escalation_Map_bak20210804
select * from EIR_IR_Escalation_Map

delete from EIR_IR_Escalation_Map where SectionID>10000
...
--NCase
select top 1000  CaseNumber, CaseCreatorID, CaseClosedDT, CaseClosedUTC, CaseCreatedUTC,CaseCreatedDT,ReportedDateDT,ReportedDateUTC, * from NCase
where  CaseNumber='210811072327'
select top 1000 CASE_NUMBER, CLOSE_DATE,EMPL_ID_CREATOR, TIMEZONE,TimeZoneId, * from IR_IR 
where Case_Number='20210721-9' or Case_Number='20210721-10' 


select top 1000  CaseNumber, CaseCreatorID, CaseClosedDT, CaseClosedUTC, CaseCreatedUTC,CaseCreatedDT,ReportedDateDT,ReportedDateUTC, * from NCase
where  CaseNumber='210721000013' or CaseNumber='210722000001'
select top 1000 CASE_NUMBER, CLOSE_DATE,EMPL_ID_CREATOR, TIMEZONE,TimeZoneId, * from IR_IR 
where Case_Number='20210721-10' 



or CaseNumber='210721000010' or CaseNumber='210721000009' 

update NCase
set CaseCreatorID=101287
where CaseNumber='210722000001'



where CaseCreatedUTC > '2011-07-1'
ORDER BY CaseCreatedUTC DESC

UPDATE NCase
SET    
		CaseCreatedUTC = '2021-01-17',
		CaseCreatedDT = '2021-01-17',
		CaseClosedUTC = '2021-01-17',
	   CaseClosedDT = '2021-01-17',
	   ReportedDateDT = '2021-01-17',
	   ReportedDateUTC= '2021-01-17'
where  CaseClosedUTC is not NULL and CaseNumber='210720000004'

UPDATE NCase
SET    CaseClosedUTC = '2021-05-22',
		CaseClosedDT = '2021-05-22',
		CaseCreatedUTC = '2011-01-21',
		CaseCreatedDT = '2011-01-21'
where (CaseNumber='210722000005') and CaseClosedUTC is not NULL
...
Update IR_IR 
set CLOSE_DATE = '2020-07-22',
    report_date = '2020-07-22'
where Case_number='20210722-3' and CLOSE_DATE is not NULL 
...
Update IR_IR 
set 
	CLOSE_DATE  = '2019-07-21'
where Case_number='20210721-10' and CLOSE_DATE is not NULL 
...
--update EIR_IR
--set ArchiveDate = '2019-07-22'
where CASE_NUMBER='220721-79'
order by report_date desc

update EIR_IR
set ArchiveDate = '1900-07-22'
where CASE_NUMBER='220721-79'
...
-- Case Linked Case
select  *
from NCaseLinkedCase
where CaseID=111430 or LinkedCaseID=111430
...
select IncidentID, *
from NCaseLinkedIR
where IncidentID=111430 or CaseID=111430 or CaseIRLinkID=111430
