...
exec spDT_CreateTestCase 'fornesd', 'hwanghan', 'Close', '2018-07-26 08:39:17.280','No', 'Substantiated'
exec spDT_CreateTestCase 'jacpad', 'hwanghan', 'Close', '2018-07-28 00:39:17.280','No', 'Substantiated'

--case policy F+3M , 3 months (UnSubstantiated)
exec spDT_CreateTestCase 'fornesd', 'hwanghan', 'Close', '2021-04-26 08:39:17.280','No', 'UnSubstantiated'
exec spDT_CreateTestCase 'jacpad', 'hwanghan', 'Close', '2021-04-28 00:39:17.280','No', 'UnSubstantiated'

--IR policy F+3 , 3 years (IR always use Substantiated policy)
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-26 08:39:17.280','No'
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-28 00:39:17.280','No'

--Archived E-Alert policy F+3M , 3 months ( E-Alert always use UnSubstantiated policy)
exec spDT_CreateTestEIR 'laxsubl', 'laxsubl', '2021-04-26 08:39:17.280'   --archived E-Alert
exec spDT_CreateTestEIR 'laxsubl', 'laxsubl', '2021-04-28 00:39:17.280'   --archived E-Alert
...
exec spDT_CreateTestCase 'fornesd', 'hwanghan', 'Close', '2018-07-23 20:39:17.280','No', 'Substantiated'
exec spDT_CreateTestCase 'nhaag', 'hwanghan', 'Close', '2021-04-27 20:39:17.280','No', 'UnSubstantiated'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 1, '20210727-134', '20210727-135'    -- type 1 - CaseLinkCase

-- generate 1 closed and 1 open cases first, then link them 
exec spDT_CreateTestCase 'laxsubl', 'hwanghan', 'Close', '2018-07-24 22:06:17.280','No', 'Partially Substantiated'
exec spDT_CreateTestCase 'laxsubl', 'hwanghan', 'Open',  '2011-06-24 17:31:17.280','No',  'Substantiated'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 1, '20210727-136', '20210727-137'    -- type 1 - CaseLinkCase

-- generate 1 closed and 1 Legal Hold cases first, then link them 
exec spDT_CreateTestCase 'laxsubl', 'hwanghan', 'Close', '2018-04-24 20:39:17.280','No', 'UnSubstantiated'
exec spDT_CreateTestCase 'laxsubl', 'hwanghan', 'Close', '2021-04-26 23:00:00.280','No', 'UnSubstantiated'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 1, '20210727-146', '20210727-147'    -- type 1 - CaseLinkCase
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 2, '20210727-148', '20210727-97'   --2 CaseLinkIR
...
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 2, '20210727-149', '20210727-98'   --2 CaseLinkIR
...
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 2, '20210727-150', '20210727-99'   --2 CaseLinkIR
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 2, '20210727-151', '20210727-100'   --2 CaseLinkIR
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 2, '20210727-152', '20210727-101'   --2 CaseLinkIR
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 3, '20210727-102', '20210727-103'    --3 IRLinkIR
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','Yes'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 3, '20210727-104', '20210727-105'    --3 IRLinkIR
...
exec spDT_CreateTestCase 'laxsubl', 'hwanghan', 'Close', '2018-04-24 20:39:17.280','No', 'UnSubstantiated'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 4, '270721-79', '20210727-123'    --4 E-Alert Escalate to Case
...
exec spDT_CreateTestIR 'laxsubl', 'Close', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 4, '270721-80', '20210727-84'    --4 EAlertLinkCase
...
exec spDT_CreateTestIR 'laxsubl', 'Open', '2018-07-24 20:12:17.280','No'
-- run above 2 lines first, then copy 2 CaseNumbers from the result to below command as ordered, then run below to link them
exec spDT_Link 4, '270721-81', '20210727-85'    --4 EAlertLinkCase
